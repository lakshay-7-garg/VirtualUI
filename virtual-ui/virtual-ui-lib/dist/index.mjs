...
import React27, { useState as useState23, useEffect as useEffect9, useRef as useRef5 } from "react";
var StockChart = ({
  data = [
    { value: 120, name: "Jan" },
    { value: 200, name: "Feb" },
  ...
  return /* @__PURE__ */ React27.createElement(
    ...
    /* @__PURE__ */ React27.createElement("svg", { width: "100%", height: "100%", style: { overflow: "visible" } }, gridLines && /* @__PURE__ */ React27.createElement("g", null, [0, 0.25, 0.5, 0.75, 1].map((percent, i) => /* @__PURE__ */ React27.createElement("g", { key: i }, /* @__PURE__ */ React27.createElement(
      "line",
      {
        x1: "0",
      ...
      item.name
    )), activeIndex >= 0 && showTooltip && /* @__PURE__ */ React27.createElement("g", null, /* @__PURE__ */ React27.createElement(
      "rect",
      {
    ...
    /* @__PURE__ */ React27.createElement("div", { style: { position: "absolute", top: "12px", left: "16px", color: "#fff", fontSize: "12px", fontWeight: "700" } }, activeIndex >= 0 ? data[activeIndex].name + " " + data[activeIndex].value : "Hover for details")
  );
};
...
var EmployeeIdCard = ({
  ...
  return /* @__PURE__ */ React28.createElement("div", { style: {
    ...
    margin: 0,
    letterSpacing: "0.5px"
  } }, companyName)), /* @__PURE__ */ React28.createElement("div", { style: { padding: "24px" } }, /* @__PURE__ */ React28.createElement("div", { style: {
    display: "flex",
    gap: "16px",
    marginBottom: "20px"
  } }, /* @__PURE__ */ React28.createElement("div", { style: {
    ...
    fontWeight: "700",
    margin: "0 0 4px"
  } }, employeeName), /* @__PURE__ */ React28.createElement("p", { style: {
    color: accent,
    fontSize: "13px",
    fontWeight: "600",
    margin: 0
  } }, designation), /* @__PURE__ */ React28.createElement("p", { style: {
    color: "rgba(255,255,255,0.5)",
    fontSize: "11px",
    margin: "8px 0 0",
    fontWeight: "500"
  } }, "Employee ID: ", employeeId))), /* @__PURE__ */ React28.createElement("div", { style: {
    display: "flex",
    alignItems: "center",
    justifyContent: "space-between",
    padding: "12px",
  ...
  } }, /* @__PURE__ */ React28.createElement("div", null, /* @__PURE__ */ React28.createElement("p", { style: {
    color: "rgba(255,255,255,0.6)",
    fontSize: "10px",
    margin: "0 0 4px",
    fontWeight: "600"
  } }, "VALID THROUGH"), /* @__PURE__ */ React28.createElement("p", { style: {
    color: "#fff",
    fontSize: "12px",
    fontWeight: "700",
    margin: 0
  } }, "Dec 31, 2024")), /* @__PURE__ */ React28.createElement("div", { style: {
    width: "40px",
    height: "40px",
    borderRadius: "8px",
    background: "#fff",
