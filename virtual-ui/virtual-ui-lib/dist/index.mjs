      ...
      /* @__PURE__ */ React2.createElement(
        ...
        /* @__PURE__ */ React2.createElement(
          ...
          /* @__PURE__ */ React2.createElement("path", {
            d: typeIcons[type] || typeIcons.info,
          }),
        ),
      ),
      /* @__PURE__ */ React2.createElement(
        ...
        /* @__PURE__ */ React2.createElement(
          "div",
          {
            style: { fontSize: "14px", fontWeight: "700", marginBottom: "3px" },
          },
          title,
        ),
        /* @__PURE__ */ React2.createElement(
        ...
        "div",
        {
          style: {
            ...
            background: avatar
              ...
              : `linear-gradient(135deg, ${accent}, ${alpha(accent, 0.5)})`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: "24px",
      ...
      stats.map((s) =>
        /* @__PURE__ */ React3.createElement(
          ...
          /* @__PURE__ */ React3.createElement(
            ...
            s.value >= 1e3 ? (s.value / 1e3).toFixed(1) + "k" : s.value,
          ),
          /* @__PURE__ */ React3.createElement(
            "div",
            {
            ...
            links.map((link) =>
              /* @__PURE__ */ React5.createElement(
                "button",
                {
                  ...
                  style: {
                    background:
                      active === link ? alpha(accent, 0.12) : "transparent",
                    border: "none",
                    padding: "7px 16px",
                    borderRadius: "9px",
                    fontSize: "14px",
          ...
          links.map((link) =>
            /* @__PURE__ */ React5.createElement(
              "button",
              {
                ...
                style: {
                  background:
                    active === link ? alpha(accent, 0.1) : "transparent",
                  border: "none",
                  padding: "11px 14px",
                  borderRadius: "10px",
                  fontSize: "14px",
    ...
    },
    {
      ...
      component: /* @__PURE__ */ React7.createElement(
        ...
        /* @__PURE__ */ React7.createElement(
          "p",
          { style: { color: "rgba(255,255,255,0.4)", fontSize: "14px" } },
          "View your stats and performance here.",
        ),
      ),
    },
    {
    ...
    /* @__PURE__ */ React7.createElement(
      ...
      /* @__PURE__ */ React7.createElement(
        ...
        /* @__PURE__ */ React7.createElement(
          ...
          activeItem == null ? void 0 : activeItem.label,
        ),
      ),
      /* @__PURE__ */ React7.createElement(
        "div",
        { style: { color: "#fff" } },
        activeItem == null ? void 0 : activeItem.component,
      ),
    ),
  );
};
...
var Charts = ({
  ...
  const areaPoints =
    `${padL},${padT + chartH} ` +
    points +
    ` ${getX(data.length - 1)},${padT + chartH}`;
  ...
  const BarChart = () => {
    ...
    return /* @__PURE__ */ React8.createElement(
      ...
      data.map((d, i) => {
        const x =
          padL + (i / data.length) * chartW + (chartW / data.length - barW) / 2;
  ...
  const LineChart = () =>
    /* @__PURE__ */ React8.createElement(
      ...
      /* @__PURE__ */ React8.createElement("polygon", {
        points: areaPoints,
        fill: "url(#lg)",
      }),
      /* @__PURE__ */ React8.createElement("polyline", {
        points,
        fill: "none",
        stroke: accent,
        strokeWidth: "2",
      ...
      slices.map((s) =>
        /* @__PURE__ */ React8.createElement(
          ...
          /* @__PURE__ */ React8.createElement("path", {
            ...
            transform:
              hovered === s.i
                ? `translate(${Math.cos(s.angle / 2 - Math.PI / 2) * 4}, ${Math.sin(s.angle / 2 - Math.PI / 2) * 4})`
                : "",
  ...
  const renderChart = () => {
    if (type === "line")
      return /* @__PURE__ */ React8.createElement(LineChart, null);
    if (type === "pie")
      return /* @__PURE__ */ React8.createElement(PieChart, null);
    if (type === "area")
      return /* @__PURE__ */ React8.createElement(AreaChart, null);
  ...
  return /* @__PURE__ */ React10.createElement(
    ...
    /* @__PURE__ */ React10.createElement(
      ...
      /* @__PURE__ */ React10.createElement(
        "style",
        null,
        `@keyframes sliderFade { from { opacity: 0; transform: scale(1.03); } to { opacity: 1; transform: scale(1); } }`,
      ),
      ...
      /* @__PURE__ */ React10.createElement(
        "button",
        {
          ...
          onMouseEnter: (e) =>
            (e.currentTarget.style.background = alpha(accent, 0.8)),
          onMouseLeave: (e) =>
        ...
        /* @__PURE__ */ React10.createElement(
          ...
          /* @__PURE__ */ React10.createElement("polyline", {
    ...
    /* @__PURE__ */ React11.createElement(
      ...
      /* @__PURE__ */ React11.createElement(
        ...
        /* @__PURE__ */ React11.createElement(
          ...
          /* @__PURE__ */ React11.createElement("polyline", {
            points: "15 18 9 12 15 6",
          }),
        ),
      ),
        ...
        /* @__PURE__ */ React12.createElement(
          "div",
          {
            style: {
              ...
              color: "#fff",
              animation:
                type === "pulse" ? `pl-pulse 1.5s ease infinite` : "none",
            },
          },
          logo[0],
        ),
      ...
      type === "bar" &&
        /* @__PURE__ */ React12.createElement(
          ...
          /* @__PURE__ */ React12.createElement(
            ...
            /* @__PURE__ */ React12.createElement("span", null, loadingText),
            /* @__PURE__ */ React12.createElement(
              "span",
              null,
              Math.round(progress),
...
var OTPInput = ({
  ...
  return /* @__PURE__ */ React13.createElement(
    ...
    /* @__PURE__ */ React13.createElement(
      ...
      completed
        ? "Verify Code"
        : `Enter ${length - otp.filter((v) => v).length} more digit${length - otp.filter((v) => v).length !== 1 ? "s" : ""}`,
    ),
    /* @__PURE__ */ React13.createElement(
      "p",
      {
...
var InvoiceCard = ({
  ...
  return /* @__PURE__ */ React14.createElement(
    ...
    /* @__PURE__ */ React14.createElement(
      ...
      /* @__PURE__ */ React14.createElement(Row, {
        label: "Subtotal",
        value: subtotal,
      }),
      /* @__PURE__ */ React14.createElement(Row, {
...
var FileUpload = ({
  ...
  const getIcon = (type) => {
    ...
    if (type.includes("video"))
      return {
        path: "M23 7l-7 5 7 5V7zM1 5h15a2 2 0 012 2v10a2 2 0 01-2 2H1a2 2 0 01-2-2V7a2 2 0 012-2z",
        color: "#34d399",
      };
    if (type.includes("audio"))
      return {
        path: "M9 18V5l12-2v13M9 18c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zm12-2c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2z",
        color: "#fbbf24",
      };
    return {
      path: "M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8zM14 2v6h6",
      color: "#94a3b8",
    };
  };
      ...
      swatches.map((s) =>
        /* @__PURE__ */ React16.createElement("button", {
          ...
          style: {
            ...
            outline: "none",
            boxShadow:
              s === "#ffffff" ? "inset 0 0 0 1px rgba(0,0,0,0.15)" : "none",
          },
...
var RatingStars = ({
  ...
  const StarIcon = ({ index }) => {
    const fill =
      active >= index ? "full" : active >= index - 0.5 ? "half" : "empty";
    const id = `half-${index}`;
    return /* @__PURE__ */ React17.createElement(
      ...
      /* @__PURE__ */ React17.createElement("polygon", {
        points:
  ...
  return /* @__PURE__ */ React17.createElement(
    ...
    /* @__PURE__ */ React17.createElement(
      ...
      Array.from({ length: total }, (_, i) =>
        /* @__PURE__ */ React17.createElement(StarIcon, {
          key: i + 1,
          index: i + 1,
        }),
      ),
    ...
    (rating > 0 || readOnly) &&
      ...
      /* @__PURE__ */ React17.createElement(
        ...
        /* @__PURE__ */ React17.createElement(
          ...
          /* @__PURE__ */ React17.createElement(
            "div",
            { style: { display: "flex", gap: "1px", marginBottom: "3px" } },
            Array.from({ length: total }, (_, i) => {
              const fill =
    ...
    !readOnly &&
      ...
      /* @__PURE__ */ React17.createElement(
        ...
        allowHalf
          ? "Hover to rate \u2022 Half stars supported"
          : "Click to rate",
      ),
  );
};
...
var StatCard = ({
  ...
  return /* @__PURE__ */ React18.createElement(
    ...
    /* @__PURE__ */ React18.createElement(
      ...
      /* @__PURE__ */ React18.createElement(
        "div",
        { className: `sc-top-${uid}` },
        showIcon &&
          /* @__PURE__ */ React18.createElement(
            "div",
            { className: `sc-icon-${uid}` },
            icon,
          ),
        showBadge &&
          /* @__PURE__ */ React18.createElement(
      ...
      /* @__PURE__ */ React18.createElement(
        "div",
        { className: `sc-value-${uid}` },
        visible ? formatCount(count) : "0",
      ),
      /* @__PURE__ */ React18.createElement(
        "div",
        { className: `sc-label-${uid}` },
        title,
      ),
      /* @__PURE__ */ React18.createElement(
        "div",
        { className: `sc-track-${uid}` },
...
var ProgressBar = ({
  ...
  const badgeColor =
    filled >= 80 ? "#16a34a" : filled >= 50 ? "#d97706" : "#dc2626";
  const badgeBg =
    filled >= 80 ? "#dcfce7" : filled >= 50 ? "#fef3c7" : "#fee2e2";
  const wrapStyle = {
      ...
      /* @__PURE__ */ React19.createElement(
        ...
        /* @__PURE__ */ React19.createElement(
          ...
          /* @__PURE__ */ React19.createElement(
            ...
            filled < 100 ? `${filled} of 100 completed` : "Completed \u2713",
          ),
          /* @__PURE__ */ React19.createElement(
            "span",
            { style: { fontSize: "0.7rem", color: "#94a3b8" } },
  ...
  if (type === "circular") {
    ...
    return /* @__PURE__ */ React19.createElement(
      ...
      /* @__PURE__ */ React19.createElement(
        "div",
        { ref, style: { ...wrapStyle, alignItems: "center", gap: 16 } },
        /* @__PURE__ */ React19.createElement(
          "svg",
          ...
          /* @__PURE__ */ React19.createElement("circle", {
            ...
            style: {
              ...
              filter: `drop-shadow(0 0 6px ${alpha(accent, 0.5)})`,
            },
          }),
          /* @__PURE__ */ React19.createElement(
            "text",
      ...
      /* @__PURE__ */ React19.createElement(
        ...
        /* @__PURE__ */ React19.createElement(
          ...
          /* @__PURE__ */ React19.createElement(
            "span",
            { style: { fontSize: "0.7rem", color: "#94a3b8" } },
            filled < 100 ? `${filled} of 100` : "Completed \u2713",
          ),
          /* @__PURE__ */ React19.createElement(
            "span",
            { style: { fontSize: "0.7rem", color: "#94a3b8" } },
              ...
              /* @__PURE__ */ React19.createElement(
                "div",
                {
                  style: {
                    ...
                    animation: done
                      ? `pb-popin-${uid} 0.3s ease ${i * 0.08}s both`
                      : "none",
                  },
                },
                done
...
var AnimatedForm = ({
  ...
  return /* @__PURE__ */ React21.createElement(
    ...
    /* @__PURE__ */ React21.createElement("textarea", {
          ...
          Array.from({ length: 5 }).map((_, i) =>
            /* @__PURE__ */ React22.createElement(
              "svg",
              {
                ...
                height: "14",
                viewBox: "0 0 24 24",
                fill: i < rating ? accent : "rgba(255,255,255,0.15)",
                stroke: "none",
              },
...
var Button = ({
  ...
  return /* @__PURE__ */ React24.createElement(
    ...
    loading
      ? /* @__PURE__ */ React24.createElement("span", null, "Loading...")
      : /* @__PURE__ */ React24.createElement(
          React24.Fragment,
          null,
          icon && /* @__PURE__ */ React24.createElement("span", null, icon),
...
var StockChart = ({
  ...
  const [dimensions, setDimensions] = useState23({ width: 500, height: 240 });
...
// src/components/EmployeeIdCard/EmployeeIdCard.jsx
  ...
  return /* @__PURE__ */ React28.createElement(
    ...
    /* @__PURE__ */ React28.createElement("div", {
      style: {
        height: "3px",
        background:
          "linear-gradient(90deg, " + accent + ", " + alpha(accent, 0.3) + ")",
      },
    }),
  );
};
