...
var StockChart = ({
  ...
  const [dimensions, setDimensions] = (0, import_react27.useState)({ width: 500, height: 240 });
  ...
  return /* @__PURE__ */ import_react27.default.createElement(
    ...
    /* @__PURE__ */ import_react27.default.createElement("svg", { width: "100%", height: "100%", style: { overflow: "visible" } }, gridLines && /* @__PURE__ */ import_react27.default.createElement("g", null, [0, 0.25, 0.5, 0.75, 1].map((percent, i) => /* @__PURE__ */ import_react27.default.createElement("g", { key: i }, /* @__PURE__ */ import_react27.default.createElement(
      "line",
      {
        x1: "0",
    ...
    ), data.map((item, i) => /* @__PURE__ */ import_react27.default.createElement(
      "circle",
      {
        key: i,
        cx: i * step,
      ...
      item.name
    )), activeIndex >= 0 && showTooltip && /* @__PURE__ */ import_react27.default.createElement("g", null, /* @__PURE__ */ import_react27.default.createElement(
      "rect",
      {
    ...
    /* @__PURE__ */ import_react27.default.createElement("div", { style: { position: "absolute", top: "12px", left: "16px", color: "#fff", fontSize: "12px", fontWeight: "700" } }, activeIndex >= 0 ? data[activeIndex].name + " " + data[activeIndex].value : "Hover for details")
  );
};
...
var EmployeeIdCard = ({
  ...
  return /* @__PURE__ */ import_react28.default.createElement("div", { style: {
    ...
    alignItems: "center",
    padding: "0 24px"
  } }, /* @__PURE__ */ import_react28.default.createElement("h3", { style: {
    color: "#fff",
    fontSize: "20px",
    fontWeight: "800",
    margin: 0,
    letterSpacing: "0.5px"
  } }, companyName)), /* @__PURE__ */ import_react28.default.createElement("div", { style: { padding: "24px" } }, /* @__PURE__ */ import_react28.default.createElement("div", { style: {
    display: "flex",
    gap: "16px",
    marginBottom: "20px"
  } }, /* @__PURE__ */ import_react28.default.createElement("div", { style: {
    ...
    flexDirection: "column",
    justifyContent: "center"
  } }, /* @__PURE__ */ import_react28.default.createElement("h4", { style: {
    color: "#fff",
    fontSize: "16px",
    fontWeight: "700",
    margin: "0 0 4px"
  } }, employeeName), /* @__PURE__ */ import_react28.default.createElement("p", { style: {
    color: accent,
    fontSize: "13px",
    fontWeight: "600",
    margin: 0
  } }, designation), /* @__PURE__ */ import_react28.default.createElement("p", { style: {
    color: "rgba(255,255,255,0.5)",
    fontSize: "11px",
    margin: "8px 0 0",
    fontWeight: "500"
  } }, "Employee ID: ", employeeId))), /* @__PURE__ */ import_react28.default.createElement("div", { style: {
    display: "flex",
    alignItems: "center",
    justifyContent: "space-between",
    padding: "12px",
  ...
  } }, /* @__PURE__ */ import_react28.default.createElement("div", null, /* @__PURE__ */ import_react28.default.createElement("p", { style: {
    color: "rgba(255,255,255,0.6)",
    fontSize: "10px",
    margin: "0 0 4px",
    fontWeight: "600"
  } }, "VALID THROUGH"), /* @__PURE__ */ import_react28.default.createElement("p", { style: {
    color: "#fff",
    fontSize: "12px",
    fontWeight: "700",
    margin: 0
  } }, "Dec 31, 2024")), /* @__PURE__ */ import_react28.default.createElement("div", { style: {
    width: "40px",
    height: "40px",
    borderRadius: "8px",
    background: "#fff",
